...
\begin{document}
	...
	\noindent Copyright topic \copyright\ 2021 Road to Data Science \\ % Copyright notice
	...
	\vspace*{2cm}
	\normalsize
	\chudau{A} sample refers to a smaller, manageable version of a larger group. It is a subset containing the characteristics of a larger population. Samples are used in statistical testing when population sizes are too large for the test to include all possible members or observations. 
	\pagebreak
	
	\input{Lipsum/chap_1_lipsum.tex}
